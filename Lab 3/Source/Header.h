...
RGBColor Selected_Color; // selected color
...
map < pair<int, int>, RGBColor > pixelNotWhite;
// x, y, color
// 0: white
// 1: black
// 2: green
...
// 5: selected
// key: x, y
// value: vector<indexShape, Color>
map<pair<int, int>, vector<pair<int, RGBColor>>> checkPointInShape;

int indexShape;

int indexShapeSelected;
RGBColor colorShapeSelected;
